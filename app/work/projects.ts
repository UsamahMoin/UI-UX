...
export const projects: Project[] = [
  ...
  },
  {
    ...
    interactionRationale: 'Finish swatches change the object in place, save state is explicit, and the acquisition action includes its lead time before commitment. Scarcity is communicated as numbered production, never artificial countdown pressure.',
  ...
  },
  {
    ...
    systemRationale: 'Oversized serif language creates appetite before the product grid appears. Mood filters use everyday words such as Bright, Comfort, and Quick, while maker and ingredient details remain structured underneath.',
