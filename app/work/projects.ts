...
export const projects: Project[] = [
  ...
  {
    slug: 'vernacular', index: '05', name: 'VERNACULAR', descriptor: 'Paper, Considered', category: 'Product / Packaging', year: '2026',
    philosophy: 'An everyday object deserves a deliberate point of view.',
    summary: 'A speculative molded-fiber tableware system, explored through material, structure, and a simple pack configurator.',
    theme: 'Material confidence',
    intentHeadline: 'A product study that lets the material explain itself.',
    colorRationale: 'Yellow and cobalt frame the warm-white fiber with the confidence of a studio specimen. Ink supplies the rules, labels, and contrast that keep the expressive composition readable.',
    systemRationale: 'Large product photography reveals the rim, ribs, and stacked geometry. Numbered specifications connect each visible detail to its purpose, while three formats share one material language.',
    interactionRationale: 'Pack sizes and quantity controls update an illustrative configuration price immediately. The local concept bag is a demonstration; it does not place orders or process payments.',
    paletteColors: [{ name: 'Studio yellow', value: '#ffed4a' }, { name: 'Ink', value: '#111111' }, { name: 'Fiber', value: '#f5f1df' }],
    principles: ['Material explains the object', 'Structure earns its visibility', 'Configuration stays understandable'],
  ...
  },
  {
    ...
    summary: 'An illustrative trail reader that connects route choices, map layers, and downloadable route notes.',
    ...
    interactionRationale: 'Selecting a route updates the line and trip facts together. Layer controls reveal terrain, water, or shelter; saves belong to each route, and notes download as a text file. The map remains explicitly illustrative and is not a navigation tool.',
  ...
  },
  {
    ...
    colorRationale: 'Near-black gives balances visual stability without default banking blue. Coral marks active controls. The balance chart uses green for a net increase, soft red for a net decrease, and gray for no change, paired with a plain-language trend label.',
    ...
    interactionRationale: 'A working local ledger connects transactions, account balances, monthly budgets, savings reserves, and bill reminders. Nested 7-, 30-, and 365-day charts share a daily ledger and dollar scale, with shaded ranges linking each zoom level. Edits recalculate the overview, while backup, restore, and undo keep personal planning recoverable.',
